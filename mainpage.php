...
<header>
    ...
    <nav class="navbar">
        ...
        <ul>
            <li><?= str_replace(' ', '-', $name) ?>
                <ul>
                    <li><a href="https://chefs-book.000webhostapp.com/addrecipe.php?name=<?= $name ?>&email=<?= $email ?>&username=<?= $user ?>">Add-Recipe</a></li>
                    <li><a href="updaterecipes.php?name=<?= $name ?>&email=<?= $email ?>&username=<?= $user ?>">Update-Recipe</a></li>
...
<section class="home" id="home">
    ...
    <div class="content">
        ...
        <p>In this website yu can find recipes all around the world. Its a userfriendly website and provides all necessary features which are requited blah blah blahh....</p>
    </div>
    ...
    <div class="box-container">
        ...
        <?php foreach($rows as $row): ?>
            ...
            <div class="box reveal">
                ...
                <h3><?= $rec_name ?></h3>
                <p><i><?= "BY: $rec_chef" ?></i></p>
                <a role="button" href="recipes.php?name=<?= $rec_name ?>&ing=<?= $rec_ing ?>&procedure=<?=$rec_proc?>&img=<?= $rec_image ?>&chef=<?= $rec_chef ?>&user=<?= $user ?>&acc_name=<?= $name ?>&email=<?= $email ?>" class="btn">View</a>
            </div>
